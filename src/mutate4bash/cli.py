...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.list:
            payload = {"schema_version": 1, "tool": 'mutate4bash', "version": __version__,
        ...
        if 'bash' in {"c", "cpp", "objc"} and not args.no_validate and not validation_command:
        ...
        write_manifest(manifest, 'mutate4bash', __version__, root, results)
